...
public class ConexionSQLite {
    ...
    // Wrapper para conexion de test: ignora close() para no cerrar la conexion compartida
    private static class NonClosingConnection implements Connection {
        ...
        @Override public PreparedStatement prepareStatement(String sql, int a, int b) throws SQLException { return delegate.prepareStatement(sql, a, b); }
        @Override public CallableStatement prepareCall(String sql, int a, int b) throws SQLException { return delegate.prepareCall(sql, a, b); }
        ...
        @Override public PreparedStatement prepareStatement(String sql, int a, int b, int c) throws SQLException { return delegate.prepareStatement(sql, a, b, c); }
        @Override public CallableStatement prepareCall(String sql, int a, int b, int c) throws SQLException { return delegate.prepareCall(sql, a, b, c); }
        @Override public PreparedStatement prepareStatement(String sql, int f) throws SQLException { return delegate.prepareStatement(sql, f); }
        @Override public PreparedStatement prepareStatement(String sql, int[] i) throws SQLException { return delegate.prepareStatement(sql, i); }
        @Override public PreparedStatement prepareStatement(String sql, String[] c) throws SQLException { return delegate.prepareStatement(sql, c); }
